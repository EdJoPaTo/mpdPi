...
wget -q --show-progress -O mpd-internetradio-destuck.zip https://github.com/EdJoPaTo/mpd-internetradio-destuck/releases/download/v0.2.0/mpd-internetradio-destuck-armv7-unknown-linux-gnueabihf.zip
